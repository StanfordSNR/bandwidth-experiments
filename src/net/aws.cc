...
AWSRequest::AWSRequest( const AWSCredentials& credentials,
                        const string& region,
...
AWSCredentials::AWSCredentials( const string& access_key, const string& secret_key, const string& session_token )
